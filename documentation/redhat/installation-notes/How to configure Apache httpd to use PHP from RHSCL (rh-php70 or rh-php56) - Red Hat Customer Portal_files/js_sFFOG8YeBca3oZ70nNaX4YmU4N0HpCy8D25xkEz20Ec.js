...
chrometwo_require(['jquery'], function($) {
    $(document).ready(function () {
        ...
        comment_show_hide_form_btns();
        
        function comment_show_hide_form_btns(){
            $(function () {
                    var commentFormActions = $('.comments-add-comment-actions');
                    commentFormActions.hide();
                    $('.add-comment-form .form-textarea').on('click', function() {
                            commentFormActions.show();
                    });
            });
        }
    });
