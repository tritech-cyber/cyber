(function(document, window, $) {
	...
	var CountdownClock = {
		...
		init: function(rpt, spoofDate) {
			this.spoofDate = spoofDate || null;
		...
		getTime: function() {
			...
			var goalTime = this.spoofDate || new Date(2018, 3, 17, 23, 59, 59);
			var timeLeft = Math.max( 0, goalTime - currentTime );
	...
	CountdownClock.init(null, window.TDA_SPOOF_DATE || null);
