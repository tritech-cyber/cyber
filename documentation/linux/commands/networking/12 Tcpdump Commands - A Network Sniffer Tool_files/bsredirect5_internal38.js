...
p;U(z,b);V(q,k,b,n);void 0==b.dvregion&&(b.dvregion=0);var C="";p=k="";try{for(var t=d,x=0;10>x&&t!=window.top;)x++,t=t.parent;d.depth=x;dv_additionalUrl=W(d);k="&aUrl="+encodeURIComponent(dv_additionalUrl.url);p="&aUrlD="+dv_additionalUrl.depth;C=d.depth+e;f&&d.depth--}catch(F){p=k=C=d.depth=""}void 0!=b.aUrl&&(k="&aUrl="+b.aUrl);e=X();f=window._dv_win&&window._dv_win.dv_config&&window._dv_win.dv_config.verifyJSCURL?dvConfig.verifyJSCURL+"?":v+"//rtb"+b.dvregion+".doubleverify.com/verifyc.js?";a:{v=
window._dv_win;t=0;try{for(;10>t;){if(v.maple&&"object"===typeof v.maple){var y=!0;break a}if(v==v.parent){y=!1;break a}t++;v=v.parent}}catch(F){}y=!1}b=f+b.dvparams+"&num=5&srcurlD="+d.depth+"&callback="+z+"&jsTagObjCallback="+q+"&ssl="+D+(n?"&dvf=0":"")+(y?"&dvf=1":"")+"&refD="+C+"&htmlmsging="+(w?"1":"0")+"&guid="+B+(null!=e?"&aadid="+e:"");c="dv_url="+encodeURIComponent(c);if(0==l||g)b=b+("&dvp_isBodyExistOnLoad="+(l?"1":"0"))+("&dvp_isOnHead="+(g?"1":"0"));T()&&(b+="&ismraid=1");h&&(b+="&dvp_sfr=1");
m&&(b+="&dvp_sfe=1");if((g=window[H("=@42E:@?")][H("2?46DE@C~C:8:?D")])&&0<g.length){h=[];h[0]=window.location.protocol+"//"+window.location.hostname;for(m=0;m<g.length;m++)h[m+1]=g[m];g=h.reverse().join(",")}else g=null;g&&(c+="&ancChain="+encodeURIComponent(g));g=4E3;/MSIE (\d+\.\d+);/.test(navigator.userAgent)&&7>=new Number(RegExp.$1)&&(g=2E3);k.length+p.length+b.length<=g&&(b+=p,c+=k);if(void 0!=window._dv_win.$dvbsr.CommonData.BrowserId&&void 0!=window._dv_win.$dvbsr.CommonData.BrowserVersion&&
...
0,{}));c.hasOwnProperty("err")&&(b=c.err);return{vdcv:26,vdcd:c.res,err:b}}catch(d){return{vdcv:26,vdcd:"0",err:b}}}function N(b){var c=0,d;for(d in b)b.hasOwnProperty(d)&&++c;return c}function ca(b,c){a:{var d={};try{if(b&&b.performance&&b.performance.getEntries){var e=b.performance.getEntries();for(b=0;b<e.length;b++){var f=e[b],g=f.name.match(/.*\/(.+?)\./);if(g&&g[1]){var k=g[1].replace(/\d+$/,""),h=c[k];if(h){for(var m=0;m<h.stats.length;m++){var B=h.stats[m];d[h.prefix+B.prefix]=Math.round(f[B.name])}delete c[k];
if(!N(c))break}}}}var w=d;break a}catch(l){}w=void 0}if(w&&N(w))return w}function V(b,c,d,e){var f=e?"https:":O(),g=e?"https:":J(c.src),k="0";"https:"===g&&(k="1");var h=window._dv_win.document.visibilityState;window[b]=function(b){try{var e={};e.protocol=f;e.ssl=k;e.dv_protocol=g;e.serverPublicDns=b.ServerPublicDns;e.ServerPublicDns=b.ServerPublicDns;e.tagElement=c;e.redirect=d;e.impressionId=b.ImpressionID;window._dv_win.$dvbsr.tags.add(b.ImpressionID,e);if(c.dvFrmWin){var w=window._dv_win.$dvbsr;
c.dvFrmWin.$uid=b.ImpressionID;w.messages&&w.messages.startSendingEvents&&w.messages.startSendingEvents(c.dvFrmWin,b.ImpressionID)}(function(){function c(){var g=window._dv_win.document.visibilityState;"prerender"===h&&"prerender"!==g&&"unloaded"!==g&&(h=g,window._dv_win.$dvbsr.registerEventCall(b.ImpressionID,{prndr:0}),window._dv_win.document.removeEventListener(d,c))}if("prerender"===h)if("prerender"!==window._dv_win.document.visibilityState&&"unloaded"!==visibilityStateLocal)window._dv_win.$dvbsr.registerEventCall(b.ImpressionID,
...
arguments)},g=["Moz","O","ms","Webkit"],k=["moz","o","ms","webkit"],h={style:f("modernizr").style},m=function(b,c){function d(){k&&(delete h.style,delete h.modElem)}var g;for(g=["modernizr","tspan","samp"];!h.style&&g.length;){var k=!0;h.modElem=f(g.shift());h.style=h.modElem.style}var e=b.length;for(g=0;g<e;g++){var l=b[g];~(""+l).indexOf("-")&&(l=cssToDOM(l));if(void 0!==h.style[l])return d(),"pfx"==c?l:!0}d();return!1},B=function(b,c,e){var f=b.charAt(0).toUpperCase()+b.slice(1),h=(b+" "+g.join(f+
" ")+f).split(" ");if("string"===typeof c||"undefined"===typeof c)return m(h,c);h=(b+" "+k.join(f+" ")+f).split(" ");for(var l in h)if(h[l]in c){if(!1===e)return h[l];b=c[h[l]];return"function"===typeof b?d(b,e||c):b}return!1};c(0,!0);c(1,B("requestFileSystem",window));c(2,window.CSS?"function"==typeof window.CSS.escape:!1);c(3,B("shapeOutside","content-box",!0));return b}catch(w){return 0}}function M(){var b=window,c=0;try{for(;b.parent&&b!=b.parent&&b.parent.document&&!(b=b.parent,10<c++););}catch(d){}return b}
function aa(){try{var b=M(),c=0,d=0,e=function(b,e,f){f&&(c=(c|1<<b)>>>0,d=(d|1<<e)>>>0)},f=b.document;e(14,0,b.playerInstance&&f.querySelector('script[src*="ads-player.com"]'));e(14,1,(b.CustomWLAdServer||b.DbcbdConfig)&&(a=f.querySelector('p[class="footerCopyright"]'),a&&a.textContent.match(/ MangaLife 2016/)));e(15,2,b.zpz&&b.zpz.createPlayer);e(15,3,b.vdApp&&b.vdApp.createPlayer);e(15,4,f.querySelector('body>div[class="z-z-z"]'));e(16,5,b.xy_checksum&&b.place_player&&(b.logjwonready&&b.logContentPauseRequested||
b.jwplayer));e(17,6,b==b.top&&""==f.title?(a=f.querySelector('body>object[id="player"]'),a&&a.data&&1<a.data.indexOf("jwplayer")&&"visibility: visible;"==a.getAttribute("style")):!1);e(17,7,f.querySelector('script[src*="sitewebvideo.com"]'));e(17,8,b.InitPage&&b.cef&&b.InitAd);e(17,9,b==b.top&&""==f.title?(a=f.querySelector("body>#player"),null!=a&&null!=(null!=a.querySelector('div[id*="opti-ad"]')||a.querySelector('iframe[src="about:blank"]'))):!1);e(17,10,b==b.top&&""==f.title&&b.InitAdPlayer?(a=
f.querySelector('body>div[id="kt_player"]'),null!=a&&null!=a.querySelector('div[class="flash-blocker"]')):!1);e(17,11,null!=b.clickplayer&&null!=b.checkRdy2);e(19,12,b.instance&&b.inject&&f.querySelector('path[id="cp-search-0"]'));return{f:c,s:d}}catch(g){return null}}function X(){function b(b){if(null==b||""==b)return"";var c=function(b,c){return b<<c|b>>>32-c},d=function(b){for(var c="",d,e=7;0<=e;e--)d=b>>>4*e&15,c+=d.toString(16);return c},g=[1518500249,1859775393,2400959708,3395469782];b+=String.fromCharCode(128);
for(var e=Math.ceil((b.length/4+2)/16),f=Array(e),l=0;l<e;l++){f[l]=Array(16);for(var n=0;16>n;n++)f[l][n]=b.charCodeAt(64*l+4*n)<<24|b.charCodeAt(64*l+4*n+1)<<16|b.charCodeAt(64*l+4*n+2)<<8|b.charCodeAt(64*l+4*n+3)}f[e-1][14]=8*(b.length-1)/Math.pow(2,32);f[e-1][14]=Math.floor(f[e-1][14]);f[e-1][15]=8*(b.length-1)&4294967295;b=1732584193;n=4023233417;var p=2562383102,v=271733878,D=3285377520,z=Array(80);for(l=0;l<e;l++){for(var q=0;16>q;q++)z[q]=f[l][q];for(q=16;80>q;q++)z[q]=c(z[q-3]^z[q-8]^z[q-
14]^z[q-16],1);var C=b;var t=n;var x=p;var y=v;var A=D;for(q=0;80>q;q++){var r=Math.floor(q/20),E=c(C,5);a:{switch(r){case 0:var u=t&x^~t&y;break a;case 1:u=t^x^y;break a;case 2:u=t&x^t&y^x&y;break a;case 3:u=t^x^y;break a}u=void 0}r=E+u+A+g[r]+z[q]&4294967295;A=y;y=x;x=c(t,30);t=C;C=r}b=b+C&4294967295;n=n+t&4294967295;p=p+x&4294967295;v=v+y&4294967295;D=D+A&4294967295}return d(b)+d(n)+d(p)+d(v)+d(D)}function c(){try{return!!window.sessionStorage}catch(g){return!0}}function d(){try{return!!window.localStorage}catch(g){return!0}}
function e(){try{var b=document.createElement("canvas");if(b.getContext&&b.getContext("2d")){var c=b.getContext("2d");c.textBaseline="top";c.font="14px 'Arial'";c.textBaseline="alphabetic";c.fillStyle="#f60";c.fillRect(0,0,62,20);c.fillStyle="#069";c.fillText("!image!",2,15);c.fillStyle="rgba(102, 204, 0, 0.7)";c.fillText("!image!",4,17);return b.toDataURL()}}catch(h){}return null}try{var f=[];f.push(["lang",navigator.language||navigator.browserLanguage]);f.push(["tz",(new Date).getTimezoneOffset()]);
f.push(["hss",c()?"1":"0"]);f.push(["hls",d()?"1":"0"]);f.push(["odb",typeof window.openDatabase||""]);f.push(["cpu",navigator.cpuClass||""]);f.push(["pf",navigator.platform||""]);f.push(["dnt",navigator.doNotTrack||""]);f.push(["canv",e()]);return b(f.join("=!!!="))}catch(g){return null}}this.createRequest=function(){var b=!1,c=window,d=0,e=!1;try{for(dv_i=0;10>=dv_i;dv_i++)if(null!=c.parent&&c.parent!=c)if(0<c.parent.location.toString().length)c=c.parent,d++,b=!0;else{b=!1;break}else{0==dv_i&&(b=
!0);break}}catch(m){b=!1}a:{try{var f=c.$sf;break a}catch(m){}f=void 0}if(0==c.document.referrer.length)b=c.location;else if(b)b=c.location;else{b=c.document.referrer;if(I(b)){a:{try{var g=c.$sf&&c.$sf.ext&&c.$sf.ext.hostURL&&c.$sf.ext.hostURL();break a}catch(m){}g=void 0}if(g&&!I(g)&&0==g.indexOf(b)){b=g;var k=!0}}e=!0}if(!window._dv_win.bsredirect5ScriptsInternal||!window._dv_win.bsredirect5Processed||0==window._dv_win.bsredirect5ScriptsInternal.length)return{isSev1:!1,url:null};this.dv_script_obj=
g=Q();g=this.dv_script=g.script;var h=g.src.replace(/^.+?callback=(.+?)(&|$)/,"$1");if(h&&(this.redirect=eval(h+"()"))&&!this.redirect.done){this.redirect.done=!0;if(P(this.redirect))return{isSev1:!0};c=L(this.redirect,b,c,d,e,g&&g.parentElement&&g.parentElement.tagName&&"HEAD"===g.parentElement.tagName,g,k,f);c+="&"+this.getVersionParamName()+"="+this.getVersion();return{isSev1:!1,url:c}}};this.isApplicable=function(){return!0};this.onFailure=function(){};this.sendRequest=function(b){dv_sendRequest(b);
try{var c=R(this.dv_script_obj&&this.dv_script_obj.injScripts),d=K("about:blank");d.id=d.name;var e=d.id.replace("iframe_","");d.setAttribute&&d.setAttribute("data-dv-frm",e);G(d,this.dv_script);if(this.dv_script){var f=this.dv_script;a:{b=null;try{if(b=d.contentWindow){var g=b;break a}}catch(m){}try{if(b=window._dv_win.frames&&window._dv_win.frames[d.name]){g=b;break a}}catch(m){}g=null}f.dvFrmWin=g}var k=S(d);if(k)k.open(),k.write(c);else{try{document.domain=document.domain}catch(m){}var h=encodeURIComponent(c.replace(/'/g,
...
this.getVersionParamName=function(){return"ver"};this.getVersion=function(){return"69"}};
