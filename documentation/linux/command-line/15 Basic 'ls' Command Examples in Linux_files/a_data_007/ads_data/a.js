...
try {
	var __IntegralASConfig = {
		...
		protocol: 'https',
		jsref: "https:\/\/googleads.g.doubleclick.net\/pagead\/ads?client=ca-pub-2601749019656699&output=html&h=250&slotname=8362602806&adk=3742234713&adf=2360683372&w=300&lmt=1531118632&loeid=201222031&guci=2.2.0.0.2.2.0&format=300x250&url=https%3A%2F%2Fwww.tecmint.com%2F15-basic-ls-command-examples-in-linux%2F&flash=0&avail_w=300&wgl=1&adsid=NT&dt=1531139990716&bpp=4&bdt=2626&fdt=361&idt=375&shv=r20180627&cbv=r20180604&saldr=aa&abxe=1&prev_fmts=728x90%2C862x90_0ads_al%2C300x250%2C780x90%2C300x250%2C300x250&correlator=8410793011153&frm=20&pv=1&ga_vid=1635363025.1528637920&ga_sid=1531139991&ga_hid=482873287&ga_fc=0&icsg=167843&dssz=24&mdo=0&mso=0&u_tz=-420&u_his=5&u_java=0&u_h=1080&u_w=1920&u_ah=1020&u_aw=1920&u_cd=24&u_nplug=0&u_nmime=0&adx=1274&ady=778&biw=1908&bih=909&scr_x=0&scr_y=1205&eid=21061122%2C21062163%2C201222021%2C368226400%2C21061318&oid=3&ref=https%3A%2F%2Fwww.google.com%2F&rx=0&eae=0&fc=528&brdim=%2C%2C0%2C27%2C1920%2C27%2C1920%2C983%2C1920%2C909&vis=1&rsz=%7C%7CoeE%7C&abl=CS&ppjl=f&pfx=0&fu=16&bc=5&jar=2018-7-9-12&ifi=7&xpc=86qVK5WVjv&p=https%3A\/\/www.tecmint.com&dtd=395",
		asid: "2c875966-8375-11e8-b13c-14dda9d4b588",
		...
		mode: "rjss",
		requrl: "",
		dtBaseURL: "https:\/\/dt.adsafeprotected.com\/dt?advEntityId=139224",
		adsafeSrc: "https:\/\/fw.adsafeprotected.com\/rfw\/servedby.flashtalking.com\/139224\/22005254\/imp\/3\/84842;2978944;201;js;DBM;WP1stBPSCRM2DBM020118043018300x250SBhvOPEX\/?ftx=&fty=&ftadz=&ftscw=&ft_custom=&ftOBA=1&ft_ifb=1&ft_domain=www.tecmint.com&ft_agentEnv=0&ft_referrer=https%3A%2F%2Fwww.tecmint.com%2F15-basic-ls-command-examples-in-linux%2F&cachebuster=555861.1181289895",
		tpiLookupURL: "",
		getTpl: "false",
		use100v: false,
		useBapiCallback: "",
		useViewabilityNotification: "",
		scriptUrl: "https:\/\/fw.adsafeprotected.com\/rjss\/servedby.flashtalking.com\/139224\/22005254\/imp\/3\/84842;2978944;201;js;DBM;WP1stBPSCRM2DBM020118043018300x250SBhvOPE",
		accountForSadImps: '',
		sendCookie: 'true',
		cookieBaseURL: 'sc.iasds01.com\/dtc?advEntityId=139224&pubEnt=22005254',
		fwMonitoring: 'false',
		doNothing: false,
		mn: "app34sje",
		mobOrTab: false,
		mobFwUrl: "https://mobile.adsafeprotected.com/internal/blocking/app/initial/139224/22005254?redirectUrl=https%3A%2F%2Fservedby.flashtalking.com%2Fimp%2F3%2F84842%3B2978944%3B201%3Bjs%3BDBM%3BWP1stBPSCRM2DBM020118043018300x250SBhvOPEX%2F%3Fftx%3D%26fty%3D%26ftadz%3D%26ftscw%3D%26ft_custom%3D%26ftOBA%3D1%26ft_ifb%3D1%26ft_domain%3Dwww.tecmint.com%26ft_agentEnv%3D0%26ft_referrer%3Dhttps%253A%252F%252Fwww.tecmint.com%252F15-basic-ls-command-examples-in-linux%252F%26cachebuster%3D555861.1181289895",
		anId: '',
		advEntityId: '139224',
		pubEntityId: '22005254',
		videoId: '',
		videoChannel: '',
...
a.getFullYear()),a=a.getTime()-b;return f.toBase(a,62)},getFwId:function(){return d()||n.advEntityId+"-"+n.pubEntityId},impressionIsIdentifiable:function(a){a&&(b=!0);return b},unq:a,getAvidIds:function(){return c},setAvidAdSessionContext:function(a){c=a}}},Ya=function(a,b){return{init:function(c){a.jsonp(c,function(a){b.send(k.DT_CODES.THIRD_PARTY,void 0,!1,!0,{field:"tpiLookup",value:a})},!1,"callback")}}},bc=function(a,b,c){return{getTime:function(){return 1E3*a.getTimeInViewInSeconds()},getTask:function(){return function(){var d=
a.getTimeInViewInSeconds(),e=a.getTimeInViewForRts();l.trigger("sendDt",b,d);if(c[e])c[e]()}}}},yb=function(){return{createPingJobs:function(a,b,c,d){f.isDef(d)&&l.trigger("addOutputItem",{output:d},"metricId",{type:a});return f(b.getTimeThresholds()).map(function(b,d){return new bc(d,a,c)})}}},oa=function(){var a=function(a,b){-1!==a.indexOf(b+"&")&&(b+="&");return a.replace(b,"")},b=function(a,b,c){var f=a.indexOf("?");b=b+"="+c;if(-1===f)return a+"?"+b;f++;return a.slice(0,f)+b+"&"+a.slice(f)},
