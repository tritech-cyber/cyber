...
l.get=function(a,b){for(var c=a+"=",d=(this.b.cookie||"").split(";"),e=0,f;e<d.length;e++){f=Ha(d[e]);if(0==f.lastIndexOf(c,0))return f.substr(c.length);if(f==a)return""}return b};
l.remove=function(a,b,c){var d=q(this.get(a));this.set(a,"",0,b,c);return d};
l.isEmpty=function(){return!this.b.cookie};
l.clear=function(){for(var a=(this.b.cookie||"").split(";"),b=[],c=[],d,e,f=0;f<a.length;f++)e=Ha(a[f]),d=e.indexOf("="),-1==d?(b.push(""),c.push(e)):(b.push(e.substring(0,d)),c.push(e.substring(d+1)));for(a=b.length-1;0<=a;a--)this.remove(b[a])};
...
l.H=function(a){var b=this.b[a];if(b){var c=this.f[b];0!=this.i?(this.h.push(a),this.b[a+1]=pa):(c&&Ea(c,a),delete this.b[a],delete this.b[a+1],delete this.b[a+2])}return!!b};
...
function Jd(a){p.processGoogleToken=p.processGoogleToken||function(a,c){var b=a,e=c;b=void 0===b?{}:b;e=void 0===e?0:e;var f=b.newToken||"",g=parseInt(b.freshLifetimeSecs||"",10)||3600,h=parseInt(b.validLifetimeSecs||"",10)||86400,k=b["1p_jar"]||"";b=b.pucrd||"";Gd();1==e?M.La():M.Ka();if(!f&&M.shouldRetry())Dd(".google.com")&&(L[1]=".google.com"),M.fa();else{var m=Ed.googleToken=Ed.googleToken||{},u=0==e&&f&&r(f)&&0<g&&0<h&&r(k),R=!(K[3]>=z())&&0!=e;if(u||R)u=z(),g=u+1E3*g,h=u+1E3*h,1E-5>Math.random()&&
(u="https://pagead2.googlesyndication.com/pagead/gen_204?id=imerr&err="+e,p.google_image_requests||(p.google_image_requests=[]),R=p.document.createElement("img"),R.src=u,p.google_image_requests.push(R)),m[5]=e,m[1]=f,m[2]=g,m[3]=h,m[4]=k,m[6]=b,Gd();if(f||!M.ka()){e=M.ja();for(f=0;f<e.length;f++)M.ha(e[f]);e.length=0}}};
Id(a)}
...
function Pd(a){Q(a,"WARNING",void 0,void 0,void 0)}
...
try{Yd[a]?f():U(f,0)}catch(g){Q(g)}},void 0);
...
function ie(a){var b=document.createElement("a");Cb(b,a);a=b.href.replace(/^[a-zA-Z]+:\/\//,"//");return"js-"+Sa(a)}
...
function pe(a){ne=new window.botguard.bg(a);T("botguard_periodic_refresh")&&N()}
...
;function ve(a){"?"==a.charAt(0)&&(a=a.substr(1));a=a.split("&");for(var b={},c=0,d=a.length;c<d;c++){var e=a[c].split("=");if(1==e.length&&e[0]||2==e.length){var f=decodeURIComponent((e[0]||"").replace(/\+/g," "));e=decodeURIComponent((e[1]||"").replace(/\+/g," "));f in b?w(b[f])?Ga(b[f],e):b[f]=[b[f],e]:b[f]=e}}return b}
...
function Ae(a,b){b.za&&(a=document.location.protocol+"//"+document.location.hostname+(document.location.port?":"+document.location.port:"")+a);var c=P("XSRF_FIELD_NAME",void 0),d=b.Ua;if(d){d[c]&&delete d[c];d=d||{};var e=a.split("#",2);c=e[0];e=1<e.length?"#"+e[1]:"";var f=c.split("?",2);c=f[0];f=ve(f[1]||"");for(var g in d)f[g]=d[g];a=td(c,f)+e}return a}
function Be(a,b){var c=P("XSRF_FIELD_NAME",void 0),d=P("XSRF_TOKEN",void 0),e=b.postBody||"",f=b.A,g=Md("XSRF_FIELD_NAME"),h;b.headers&&(h=b.headers["Content-Type"]);b.Ya||qd(J(a)[3]||null)&&!b.withCredentials&&qd(J(a)[3]||null)!=document.location.hostname||"POST"!=b.method||h&&"application/x-www-form-urlencoded"!=h||b.A&&b.A[g]||(f||(f={}),f[c]=d);f&&r(e)&&(e=ve(e),db(e,f),e=b.ma&&"JSON"==b.ma?JSON.stringify(e):sd(e));f=e||f&&!$a(f);!xe&&f&&"POST"!=b.method&&(xe=!0,Q(Error("AJAX request with postData should use POST")));
return e}
...
return d}
function He(a){if(ua(a))for(var b in a){var c;(c="html_content"==b)||(c=b.length-5,c=0<=c&&b.indexOf("_html",c)==c);if(c){c=b;var d=Bb(a[b]);a[c]=d}else He(a[b])}}
...
function De(a,b,c,d,e,f,g){function h(){4==(k&&"readyState"in k?k.readyState:0)&&b&&Od(b)(k)}
...
;var Je={},Ke=0;function Le(a,b,c,d,e){e=void 0===e?"":e;a&&(c&&(c=Ta,c=!(c&&0<=c.toLowerCase().indexOf("cobalt"))),c?a&&(a=Kb("IFRAME",{src:'javascript:"data:text/html,<body><img src=\\"'+a+'\\"></body>"',style:"display:none"}),(9==a.nodeType?a:a.ownerDocument||a.document).body.appendChild(a)):e?De(a,b,"POST",e,d):P("USE_NET_AJAX_FOR_PING_TRANSPORT",!1)||d?De(a,b,"GET","",d):Me(a,b))}
function Me(a,b){var c=new Image,d=""+Ke++;Je[d]=c;c.onload=c.onerror=function(){b&&Je[d]&&b();delete Je[d]};
c.src=a}
;var Ne={},Oe=0;
function Pe(a,b,c,d,e,f){f=f||{};f.name=c||P("INNERTUBE_CONTEXT_CLIENT_NAME",1);f.version=d||P("INNERTUBE_CONTEXT_CLIENT_VERSION",void 0);b=void 0===b?"ERROR":b;e=void 0===e?!1:e;e=window&&window.yterr||(void 0===e?!1:e)||!1;if(a&&e&&!(5<=Oe)){e=a.stacktrace;c=a.columnNumber;d=v("window.location.href");if(r(a))a={message:a,name:"Unknown error",lineNumber:"Not available",fileName:d,stack:"Not available"};else{var g=!1;try{var h=a.lineNumber||a.line||"Not available"}catch(R){h="Not available",g=!0}try{var k=
a.fileName||a.filename||a.sourceURL||p.$googDebugFname||d}catch(R){k="Not available",g=!0}a=!g&&a.lineNumber&&a.fileName&&a.stack&&a.message&&a.name?a:{message:a.message||"Not available",name:a.name||"UnknownError",lineNumber:h,fileName:k,stack:a.stack||"Not available"}}e=e||a.stack;h=a.lineNumber.toString();isNaN(h)||isNaN(c)||(h=h+":"+c);if(!(Ne[a.message]||0<=e.indexOf("/YouTubeCenter.js")||0<=e.indexOf("/mytube.js"))){k=e;h={Ua:{a:"logerror",t:"jserror",type:a.name,msg:a.message.substr(0,1E3),
...
;var Qe=window.yt&&window.yt.msgs_||window.ytcfg&&window.ytcfg.msgs||{};t("yt.msgs_",Qe,void 0);function Re(a){Kd(Qe,arguments)}
;function Se(){}
function Te(a,b){return Ue(a,1,b)}
;function Ve(){}
n(Ve,Se);function Ue(a,b,c){isNaN(c)&&(c=void 0);var d=v("yt.scheduler.instance.addJob");return d?d(a,b,c):void 0===c?(a(),NaN):U(a,c||0)}
...
qa(Ve);Ve.getInstance();var Xe=[],Ye=!1;function Ze(){if("1"!=Xa(Nd(),"args","privembed")||!T("do_not_set_cookies_for_ads_on_youtube_nocookie")){var a=function(){Ye=!0;"google_ad_status"in window?O("DCLKSTAT",1):O("DCLKSTAT",2)};
...
cf.prototype.stopImmediatePropagation=function(){this.event&&(this.event.cancelBubble=!0,this.event.stopImmediatePropagation&&this.event.stopImmediatePropagation())};var Za=v("ytEventsEventsListeners")||{};t("ytEventsEventsListeners",Za,void 0);var ef=v("ytEventsEventsCounter")||{count:0};t("ytEventsEventsCounter",ef,void 0);function ff(a,b,c,d){d=void 0===d?!1:d;a.addEventListener&&("mouseenter"!=b||"onmouseenter"in document?"mouseleave"!=b||"onmouseenter"in document?"mousewheel"==b&&"MozBoxSizing"in document.documentElement.style&&(b="MozMousePixelScroll"):b="mouseout":b="mouseover");return Ya(function(e){return!!e.length&&e[0]==a&&e[1]==b&&e[2]==c&&e[4]==!!d})}
function V(a,b,c){var d=void 0===d?!1:d;if(!a||!a.addEventListener&&!a.attachEvent)return"";var e=ff(a,b,c,d);if(e)return e;e=++ef.count+"";var f=!("mouseenter"!=b&&"mouseleave"!=b||!a.addEventListener||"onmouseenter"in document);var g=f?function(d){d=new cf(d);if(!Mb(d.relatedTarget,function(b){return b==a}))return d.currentTarget=a,d.type=b,c.call(a,d)}:function(b){b=new cf(b);
...
function gf(a){a&&("string"==typeof a&&(a=[a]),C(a,function(a){if(a in Za){var b=Za[a],d=b[0],e=b[1],f=b[3];b=b[4];d.removeEventListener?d.removeEventListener(e,f,b):d.detachEvent&&d.detachEvent("on"+e,f);delete Za[a]}}))}
;function hf(a){this.o=a;this.b=null;this.i=0;this.m=null;this.j=0;this.f=[];for(a=0;4>a;a++)this.f.push(0);this.h=0;this.D=V(window,"mousemove",x(this.F,this));a=x(this.w,this);ta(a)&&(a=Od(a));this.G=window.setInterval(a,25)}
A(hf,G);hf.prototype.F=function(a){q(a.b)||df(a);var b=a.b;q(a.g)||df(a);this.b=new Fb(b,a.g)};
...
;function zf(a,b,c){b=void 0===b?{}:b;c=void 0===c?!1:c;var d=P("EVENT_ID");d&&(b.ei||(b.ei=d));if(b){d=a;var e=P("VALID_SESSION_TEMPDATA_DOMAINS",[]),f=qd(J(window.location.href)[3]||null);f&&e.push(f);f=qd(J(d)[3]||null);if(0<=za(e,f)||!f&&0==d.lastIndexOf("/",0))if(T("autoescape_tempdata_url")&&(e=document.createElement("a"),Cb(e,d),d=e.href),d){f=J(d);d=f[5];e=f[6];f=f[7];var g="";d&&(g+=d);e&&(g+="?"+e);f&&(g+="#"+f);d=g;e=d.indexOf("#");if(d=0>e?d:d.substr(0,e)){if(b.itct||b.ved)b.csn=b.csn||
wf();if(h){var h=parseInt(h,10);isFinite(h)&&0<h&&(d="ST-"+Sa(d).toString(36),e=b?sd(b):"",xf(d,e,h||5),yf(b))}else h="ST-"+Sa(d).toString(36),d=b?sd(b):"",xf(h,d,5),yf(b)}}}if(c)return!1;if((window.ytspf||{}).enabled)spf.navigate(a);else{var k=void 0===k?{}:k;var m=void 0===m?"":m;var u=void 0===u?window:u;c=u.location;a=td(a,k)+m;a=a instanceof E?a:yb(a);c.href=wb(a)}return!0}
;t("yt.abuse.botguardInitialized",v("yt.abuse.botguardInitialized")||qe,void 0);t("yt.abuse.invokeBotguard",v("yt.abuse.invokeBotguard")||re,void 0);t("yt.abuse.dclkstatus.checkDclkStatus",v("yt.abuse.dclkstatus.checkDclkStatus")||$e,void 0);t("yt.player.exports.navigate",v("yt.player.exports.navigate")||zf,void 0);t("yt.util.activity.init",v("yt.util.activity.init")||kf,void 0);t("yt.util.activity.getTimeSinceActive",v("yt.util.activity.getTimeSinceActive")||mf,void 0);
...
t("ytytLoggingTransportCapturedTime_",v("ytLoggingTransportCapturedTime_")||{},void 0);function Hf(a,b){Df[a.endpoint]=b;if(a.V){var c=a.V;var d={};c.videoId?d.videoId=c.videoId:c.playlistId&&(d.playlistId=c.playlistId);Ff[a.V.token]=d;c=If(a.endpoint,a.V.token)}else c=If(a.endpoint);c.push(a.payload);c.length>=(Number(T("web_logging_max_batch")||0)||20)?Jf():Kf()}
function Jf(){Ud(Ef);if(!$a(X)){for(var a in X){var b=Cf[a];if(!b){var c=Df[a];if(!c)continue;b=new c;Cf[a]=b}c=void 0;var d=a,e=b,f=Af[d],g=Gf[d]||{};Gf[d]=g;b=Math.round(N());for(c in X[d]){var h=e.b;h={client:{hl:h.Ca,gl:h.Ba,clientName:h.Aa,clientVersion:h.innertubeContextClientVersion}};P("DELEGATED_SESSION_ID")&&(h.user={onBehalfOfUser:P("DELEGATED_SESSION_ID")});h={context:h};h[f]=If(d,c);g.dispatchedEventCount=g.dispatchedEventCount||0;g.dispatchedEventCount+=h[f].length;h.requestTimeMs=b;
var k=Ff[c];if(k)a:{var m=h,u=c;if(k.videoId)var R="VIDEO";else if(k.playlistId)R="PLAYLIST";else break a;m.credentialTransferTokenTargetId=k;m.context=m.context||{};m.context.user=m.context.user||{};m.context.user.credentialTransferTokens=[{token:u,scope:R}]}delete Ff[c];Lf(e,d,h)}c=g;d=b;c.previousDispatchMs&&(b=d-c.previousDispatchMs,e=c.diffCount||0,c.averageTimeBetweenDispatchesMs=e?(c.averageTimeBetweenDispatchesMs*e+b)/(e+1):b,c.diffCount=e+1);c.previousDispatchMs=d;delete X[a]}$a(X)||Kf()}}
function Kf(){Ud(Ef);Ef=U(Jf,P("LOGGING_BATCH_TIMEOUT",1E4))}
...
;function Nf(a){this.b=a||{innertubeApiKey:Md("INNERTUBE_API_KEY"),innertubeApiVersion:Md("INNERTUBE_API_VERSION"),Aa:P("INNERTUBE_CONTEXT_CLIENT_NAME","WEB"),innertubeContextClientVersion:Md("INNERTUBE_CONTEXT_CLIENT_VERSION"),Ca:Md("INNERTUBE_CONTEXT_HL"),Ba:Md("INNERTUBE_CONTEXT_GL"),Da:Md("INNERTUBE_HOST_OVERRIDE")||""}}
function Lf(a,b,c){var d={};!P("VISITOR_DATA")&&.01>Math.random()&&Q(Error("Missing VISITOR_DATA when sending innertube request."),"WARNING");var e={headers:{"Content-Type":"application/json","X-Goog-Visitor-Id":P("VISITOR_DATA","")},method:"POST",A:c,ma:"JSON",K:function(){d.K()},
la:d.K,C:function(a,b){d.C&&d.C(b)},
ab:function(a){d.C&&d.C(a)},
onError:function(a,b){if(d.onError)d.onError(b)},
Za:function(a){if(d.onError)d.onError(a)},
timeout:d.timeout,withCredentials:!0},f=Yb();f&&(e.headers.Authorization=f,e.headers["X-Goog-AuthUser"]=P("SESSION_INDEX",0));var g="",h=a.b.Da;h&&(g=h);f&&!g&&(e.headers["x-origin"]=window.location.origin);a=""+g+Of(a.b.innertubeApiVersion,b,c)+"?alt=json&key="+a.b.innertubeApiKey;try{T("use_fetch_for_op_xhr")?ze(a,e):Ie(a,e)}catch(k){if("InvalidAccessError"==k)Q(Error("An extension is blocking network request."),"WARNING");else throw k;}}
...
;function Rf(a){a=a||{};this.url=a.url||"";this.args=a.args||bb(Sf);this.assets=a.assets||{};this.attrs=a.attrs||bb(Tf);this.params=a.params||bb(Uf);this.minVersion=a.min_version||"8.0.0";this.fallback=a.fallback||null;this.fallbackMessage=a.fallbackMessage||null;this.html5=!!a.html5;this.disable=a.disable||{};this.loaded=!!a.loaded;this.messages=a.messages||{}}
var Sf={enablejsapi:1},Tf={},Uf={allowscriptaccess:"always",allowfullscreen:"true",bgcolor:"#000000"};function Vf(a){var b=new Rf,c;for(c in a)if(a.hasOwnProperty(c)){var d=a[c];b[c]="object"==ra(d)?bb(d):d}return b}
;function Wf(){G.call(this);this.b=[]}
n(Wf,G);Wf.prototype.l=function(){for(;this.b.length;){var a=this.b.pop();a.target.removeEventListener(a.name,a.Wa)}G.prototype.l.call(this)};var Xf=/cssbin\/(?:debug-)?([a-zA-Z0-9_-]+?)(?:-2x|-web|-rtl|-vfl|.css)/;function Yf(a){a=a||"";if(window.spf){var b=a.match(Xf);spf.style.load(a,b?b[1]:"",void 0)}else Zf(a)}
function Zf(a){var b=$f(a),c=document.getElementById(b),d=c&&Sd(c,"loaded");d||c&&!d||(c=ag(a,b,function(){Sd(c,"loaded")||(Qd(c),be(b),U(y(ce,b),0))}))}
...
function $f(a){var b=document.createElement("A");a=zb(a);Cb(b,a);b=b.href.replace(/^[a-zA-Z]+:\/\//,"//");return"css-"+Sa(b)}
;var bg=v("ytLoggingLatencyUsageStats_")||{};t("ytLoggingLatencyUsageStats_",bg,void 0);var cg=0;function dg(a){bg[a]=bg[a]||{count:0};var b=bg[a];b.count++;b.time=N();cg||(cg=Ue(eg,0,5E3));return 10<b.count?(11==b.count&&Pe(Error("CSI data exceeded logging limit with key: "+a),0==a.indexOf("info")?"WARNING":"ERROR"),!0):!1}
function eg(){var a=N(),b;for(b in bg)6E4<a-bg[b].time&&delete bg[b];cg=0}
;function fg(a,b){this.version=a;this.args=b}
;function gg(a){this.topic=a}
gg.prototype.toString=function(){return this.topic};var hg=v("ytPubsub2Pubsub2Instance")||new I;I.prototype.subscribe=I.prototype.subscribe;I.prototype.unsubscribeByKey=I.prototype.H;I.prototype.publish=I.prototype.I;I.prototype.clear=I.prototype.clear;t("ytPubsub2Pubsub2Instance",hg,void 0);t("ytPubsub2Pubsub2SubscribedKeys",v("ytPubsub2Pubsub2SubscribedKeys")||{},void 0);t("ytPubsub2Pubsub2TopicToKeys",v("ytPubsub2Pubsub2TopicToKeys")||{},void 0);t("ytPubsub2Pubsub2IsAsync",v("ytPubsub2Pubsub2IsAsync")||{},void 0);
t("ytPubsub2Pubsub2SkipSubKey",null,void 0);function ig(a,b){var c=v("ytPubsub2Pubsub2Instance");c&&c.publish.call(c,a.toString(),a,b)}
;var Y=window.performance||window.mozPerformance||window.msPerformance||window.webkitPerformance||{};function jg(){var a=P("TIMING_TICK_EXPIRATION");a||(a={},O("TIMING_TICK_EXPIRATION",a));return a}
function kg(){var a=jg(),b;for(b in a)We(a[b]);O("TIMING_TICK_EXPIRATION",{})}
;function lg(a,b){fg.call(this,1,arguments)}
n(lg,fg);function mg(a,b){fg.call(this,1,arguments)}
n(mg,fg);var ng=new gg("aft-recorded"),og=new gg("timing-sent");var pg=z().toString();var qg={vc:!0},rg={ad_allowed:"adTypesAllowed",ad_at:"adType",ad_cpn:"adClientPlaybackNonce",ad_docid:"adVideoId",yt_ad_an:"adNetworks",p:"httpProtocol",t:"transportProtocol",cpn:"clientPlaybackNonce",csn:"clientScreenNonce",docid:"videoId",is_nav:"isNavigation",yt_lt:"loadType",yt_ad:"isMonetized",nr:"webInfo.navigationReason",ncnp:"webInfo.nonPreloadedNodeCount",paused:"playerInfo.isPausedOnLoad",fmt:"playerInfo.itag",yt_pl:"watchInfo.isPlaylist",yt_ad_pr:"prerollAllowed",yt_red:"isRedSubscriber",
st:"serverTimeMs",vph:"viewportHeight",vpw:"viewportWidth",yt_vis:"isVisible"},sg="ap c cver ei srt yt_fss yt_li plid vpil vpni vpst yt_eil vpni2 vpil2 icrc icrt pa GetBrowse_rid GetPlayer_rid GetSearch_rid GetWatchNext_rid cmt pc prerender psc rc start yt_abt yt_fn yt_fs yt_pft yt_pre yt_pt yt_pvis yt_ref yt_sts".split(" "),wg="isNavigation isMonetized playerInfo.isPausedOnLoad prerollAllowed isRedSubscriber isVisible watchInfo.isPlaylist".split(" "),xg=!1;
function yg(a){if("_"!=a[0]){var b=a;Y.mark&&(0==b.lastIndexOf("mark_",0)||(b="mark_"+b),Y.mark(b))}b=zg();var c=N();b[a]&&(b["_"+a]=b["_"+a]||[b[a]],b["_"+a].push(c));b[a]=c;b=jg();if(c=b[a])We(c),b[a]=0;Ag()["tick_"+a]=void 0;N();T("csi_on_gel")?(b=Bg(),"_start"==a?dg("baseline_"+b)||Mf("latencyActionBaselined",{clientActionNonce:b},void 0,void 0):dg("tick_"+a+"_"+b)||Mf("latencyActionTicked",{tickName:a,clientActionNonce:b},void 0,void 0),a=!0):a=!1;if(a=!a)a=!v("yt.timing.pingSent_");if(a&&(b=
Md("TIMING_ACTION"),a=zg(),v("ytglobal.timingready_")&&b&&a._start&&(b=Cg()))){T("tighter_critical_section")&&!xg&&(ig(ng,new lg(Math.round(b-a._start),void 0)),xg=!0);b=!0;c=P("TIMING_WAIT",[]);if(c.length)for(var d=0,e=c.length;d<e;++d)if(!(c[d]in a)){b=!1;break}b&&Dg()}}
function Eg(){var a=Fg().info.yt_lt="hot_bg";Ag().info_yt_lt=a;if(T("csi_on_gel"))if("yt_lt"in rg){var b={},c=rg.yt_lt;0<=za(wg,c)&&(a=!!a);c=c.split(".");for(var d=b,e=0;e<c.length-1;e++)d[c[e]]=d[c[e]]||{},d=d[c[e]];b[c[c.length-1]]=a;a=Bg();c=Object.keys(b).join("");dg("info_"+c+"_"+a)||(b.clientActionNonce=a,Mf("latencyActionInfo",b,void 0,void 0))}else 0<=za(sg,"yt_lt")||Q(Error("Unknown label yt_lt logged with GEL CSI."))}
function Cg(){var a=zg();if(a.aft)return a.aft;for(var b=P("TIMING_AFT_KEYS",["ol"]),c=b.length,d=0;d<c;d++){var e=a[b[d]];if(e)return e}return NaN}
function Dg(){kg();if(!T("csi_on_gel")){var a=zg(),b=Fg().info,c=a._start,d;for(d in a)if(0==d.lastIndexOf("_",0)&&w(a[d])){var e=d.slice(1);if(e in qg){var f=Ca(a[d],function(a){return Math.round(a-c)});
b["all_"+e]=f.join()}delete a[d]}e=!!b.ap;if(f=v("ytglobal.timingReportbuilder_")){if(f=f(a,b,void 0))Gg(f,e),Hg(),Ig(),Jg(!1,void 0),P("TIMING_ACTION")&&O("PREVIOUS_ACTION",P("TIMING_ACTION")),O("TIMING_ACTION","")}else{var g=P("CSI_SERVICE_NAME","youtube");f={v:2,s:g,action:P("TIMING_ACTION",void 0)};var h=b.srt;void 0!==a.srt&&delete b.srt;if(b.h5jse){var k=window.location.protocol+v("ytplayer.config.assets.js");(k=Y.getEntriesByName?Y.getEntriesByName(k)[0]:null)?b.h5jse=Math.round(b.h5jse-k.responseEnd):
delete b.h5jse}a.aft=Cg();Kg()&&"youtube"==g&&(Eg(),g=a.vc,k=a.pbs,delete a.aft,b.aft=Math.round(k-g));for(var m in b)"_"!=m.charAt(0)&&(f[m]=b[m]);a.ps=N();b={};m=[];for(d in a)"_"!=d.charAt(0)&&(g=Math.round(a[d]-c),b[d]=g,m.push(d+"."+g));f.rt=m.join(",");(a=v("ytdebug.logTiming"))&&a(f,b);Gg(f,e,void 0);ig(og,new mg(b.aft+(h||0),void 0))}}}
var Ig=x(Y.clearResourceTimings||Y.webkitClearResourceTimings||Y.mozClearResourceTimings||Y.msClearResourceTimings||Y.oClearResourceTimings||pa,Y);
function Gg(a,b,c){if(T("debug_csi_data")){var d=v("yt.timing.csiData");d||(d=[],t("yt.timing.csiData",d,void 0));d.push({page:location.href,time:new Date,args:a})}d="";for(var e in a)d+="&"+e+"="+a[e];a="/csi_204?"+d.substring(1);if(window.navigator&&window.navigator.sendBeacon&&b){var f=void 0===f?"":f;try{window.navigator&&window.navigator.sendBeacon&&window.navigator.sendBeacon(a,f)||Le(a,void 0,void 0,void 0,f)}catch(g){Le(a,void 0,void 0,void 0,f)}}else Le(a);Jg(!0,c)}
function Bg(){var a=Fg().nonce;if(!a){a:{if(window.crypto&&window.crypto.getRandomValues)try{var b=Array(16),c=new Uint8Array(16);window.crypto.getRandomValues(c);for(a=0;a<b.length;a++)b[a]=c[a];var d=b;break a}catch(e){}d=Array(16);for(b=0;16>b;b++){c=z();for(a=0;a<c%23;a++)d[b]=Math.random();d[b]=Math.floor(256*Math.random())}if(pg)for(b=1,c=0;c<pg.length;c++)d[b%16]=d[b%16]^d[(b-1)%16]/4^pg.charCodeAt(c),b++}b=[];for(c=0;c<d.length;c++)b.push("abcdefghijklmnopqrstuvwxyzABCDEFGHIJKLMNOPQRSTUVWXYZ0123456789-_".charAt(d[c]&
63));a=b.join("");Fg().nonce=a}return a}
function zg(){return Fg().tick}
function Ag(){var a=Fg();"gel"in a||(a.gel={});return a.gel}
function Fg(){return v("ytcsi.data_")||Hg()}
...
;function Lg(a,b){G.call(this);this.m=this.R=a;this.G=b;this.o=!1;this.f={};this.O=this.F=null;this.w=new I;mc(this,y(nc,this.w));this.i={};this.M=this.P=this.h=this.Y=this.b=null;this.L=!1;this.j=this.D=null;this.S={};this.qa=["onReady"];this.X=null;this.ga=NaN;this.N={};Mg(this);this.U("WATCH_LATER_VIDEO_ADDED",this.Fa.bind(this));this.U("WATCH_LATER_VIDEO_REMOVED",this.Ga.bind(this));this.U("onAdAnnounce",this.ta.bind(this));this.ra=new Wf(this);mc(this,y(nc,this.ra))}
n(Lg,G);l=Lg.prototype;
l.da=function(a){if(!this.g){a instanceof Rf||(a=new Rf(a));this.Y=a;this.b=Vf(a);this.h=this.b.attrs.id||this.h;"video-player"==this.h&&(this.h=this.G,this.b.attrs.id=this.G);this.m.id==this.h&&(this.h+="-player",this.b.attrs.id=this.h);this.b.args.enablejsapi="1";this.b.args.playerapiid=this.G;this.P||(this.P=Ng(this,this.b.args.jsapicallback||"onYouTubePlayerReady"));this.b.args.jsapicallback=null;if(a=this.b.attrs.width)this.m.style.width=Qb(Number(a)||a);if(a=this.b.attrs.height)this.m.style.height=Qb(Number(a)||
a);Og(this);this.o&&Pg(this)}};
l.wa=function(){return this.Y};
function Pg(a){a.b.loaded||(a.b.loaded=!0,"0"!=a.b.args.autoplay?a.f.loadVideoByPlayerVars(a.b.args):a.f.cueVideoByPlayerVars(a.b.args))}
function Qg(a){var b=!0,c=Rg(a);c&&a.b&&(a=a.b,b=Sd(c,"version")==a.assets.js);return b&&!!v("yt.player.Application.create")}
function Og(a){if(!a.g&&!a.L){var b=Qg(a);if(b&&"html5"==(Rg(a)?"html5":null))a.M="html5",a.o||Sg(a);else if(Tg(a),a.M="html5",b&&a.j)a.R.appendChild(a.j),Sg(a);else{a.b.loaded=!0;var c=!1;a.D=function(){c=!0;var b=Vf(a.b);v("yt.player.Application.create")(a.R,b);Sg(a)};
a.L=!0;b?a.D():(ge(a.b.assets.js,a.D),Yf(a.b.assets.css),Ug(a)&&!c&&t("yt.player.Application.create",null,void 0))}}}
function Rg(a){var b=Hb(a.h);!b&&a.m&&a.m.querySelector&&(b=a.m.querySelector("#"+a.h));return b}
function Sg(a){if(!a.g){var b=Rg(a),c=!1;try{b&&b.getApiInterface&&b.getApiInterface()&&(c=!0)}catch(d){Pd(Error("Error calling getApiInterface: "+d))}c?(a.L=!1,b.isNotServable&&b.isNotServable(a.b.args.video_id)||Vg(a)):a.ga=U(function(){Sg(a)},50)}}
function Vg(a){Mg(a);a.o=!0;var b=Rg(a);b.addEventListener&&(a.F=Wg(a,b,"addEventListener"));b.removeEventListener&&(a.O=Wg(a,b,"removeEventListener"));var c=b.getApiInterface();c=c.concat(b.getInternalApiInterface());for(var d=0;d<c.length;d++){var e=c[d];a.f[e]||(a.f[e]=Wg(a,b,e))}for(var f in a.i)a.F(f,a.i[f]);Pg(a);a.P&&a.P(a.f);a.w.I("onReady",a.f)}
function Wg(a,b,c){var d=b[c];return function(){try{return a.X=null,d.apply(b,arguments)}catch(e){"sendAbandonmentPing"!=c&&(e.message+=" ("+c+")",a.X=e,Pd(e))}}}
function Mg(a){a.o=!1;if(a.O)for(var b in a.i)a.O(b,a.i[b]);for(var c in a.N)Ud(parseInt(c,10));a.N={};a.F=null;a.O=null;for(var d in a.f)a.f[d]=null;a.f.addEventListener=a.U.bind(a);a.f.removeEventListener=a.Ma.bind(a);a.f.destroy=a.dispose.bind(a);a.f.getLastError=a.xa.bind(a);a.f.getPlayerType=a.ya.bind(a);a.f.getCurrentVideoConfig=a.wa.bind(a);a.f.loadNewVideoConfig=a.da.bind(a);a.f.isReady=a.Ea.bind(a)}
l.Ea=function(){return this.o};
l.U=function(a,b){var c=this,d=Ng(this,b);if(d){if(!(0<=za(this.qa,a)||this.i[a])){var e=Xg(this,a);this.F&&this.F(a,e)}this.w.subscribe(a,d);"onReady"==a&&this.o&&U(function(){d(c.f)},0)}};
l.Ma=function(a,b){if(!this.g){var c=Ng(this,b);c&&ad(this.w,a,c)}};
function Ng(a,b){var c=b;if("string"==typeof b){if(a.S[b])return a.S[b];c=function(){var a=v(b);a&&a.apply(p,arguments)};
a.S[b]=c}return c?c:null}
function Xg(a,b){var c="ytPlayer"+b+a.G;a.i[b]=c;p[c]=function(c){var d=a.b&&a.b.args&&a.b.args.fflags;if(d&&0>d.indexOf("use_html5_player_event_timeout=true"))a.w.I(b,c);else{var f=U(function(){if(!a.g){a.w.I(b,c);var d=a.N,e=String(f);e in d&&delete d[e]}},0);
ab(a.N,String(f))}};
return c}
...
l.ya=function(){return this.M||(Rg(this)?"html5":null)};
l.xa=function(){return this.X};
function Tg(a){yg("dcp");a.cancel();Mg(a);a.M=null;a.b&&(a.b.loaded=!1);var b=Rg(a);b&&(Qg(a)||!Ug(a)?a.j=b:(b&&b.destroy&&b.destroy(),a.j=null));for(a=a.R;b=a.firstChild;)a.removeChild(b)}
l.cancel=function(){this.D&&me(this.b.assets.js,this.D);Ud(this.ga);this.L=!1};
l.l=function(){Tg(this);if(this.j&&this.b&&this.j.destroy)try{this.j.destroy()}catch(b){Q(Error("Error destroying player: "+b))}this.S=null;for(var a in this.i)p[this.i[a]]=null;this.Y=this.b=this.f=null;delete this.R;delete this.m;G.prototype.l.call(this)};
function Ug(a){return a.b&&a.b.args&&a.b.args.fflags?-1!=a.b.args.fflags.indexOf("player_destroy_old_version=true"):!1}
;var Yg={},Zg="player_uid_"+(1E9*Math.random()>>>0);function $g(a){var b="player";b=r(b)?Hb(b):b;var c=Zg+"_"+(b[va]||(b[va]=++wa)),d=Yg[c];if(d)return d.da(a),d.f;d=new Lg(b,c);Yg[c]=d;be("player-added",d.f);mc(d,y(ah,d));U(function(){d.da(a)},0);
return d.f}
function ah(a){delete Yg[a.G]}
;function bh(a){return(0==a.search("cue")||0==a.search("load"))&&"loadModule"!=a}
...
function dh(a,b,c){if(ua(a)){b="endSeconds startSeconds mediaContentUrl suggestedQuality videoId two_stage_token".split(" ");c={};for(var d=0;d<b.length;d++){var e=b[d];a[e]&&(c[e]=a[e])}return c}return{videoId:a,startSeconds:b,suggestedQuality:c}}
function eh(a,b,c,d){if(ua(a)&&!w(a)){b="playlist list listType index startSeconds suggestedQuality".split(" ");c={};for(d=0;d<b.length;d++){var e=b[d];a[e]&&(c[e]=a[e])}return c}b={index:b,startSeconds:c,suggestedQuality:d};r(a)&&16==a.length?b.list="PL"+a:b.playlist=a;return b}
function fh(a){var b=a.video_id||a.videoId;if(r(b)){var c=qf()||{},d=qf()||{};q(void 0)?d[b]=void 0:delete d[b];var e=z()+3E5,f=sf;if(f&&window.JSON){r(d)||(d=JSON.stringify(d,void 0));try{f.set("yt-player-two-stage-token",d,e)}catch(g){f.remove("yt-player-two-stage-token")}}(b=c[b])&&(a.two_stage_token=b)}}
;function gh(a){G.call(this);this.b=a;this.b.subscribe("command",this.na,this);this.f={};this.i=!1}
A(gh,G);l=gh.prototype;l.start=function(){this.i||this.g||(this.i=!0,hh(this.b,"RECEIVING"))};
l.na=function(a,b,c){if(this.i&&!this.g){var d=b||{};switch(a){case "addEventListener":r(d.event)&&(a=d.event,a in this.f||(c=x(this.Oa,this,a),this.f[a]=c,this.addEventListener(a,c)));break;case "removeEventListener":r(d.event)&&ih(this,d.event);break;default:this.h.isReady()&&this.h[a]&&(b=jh(a,b||{}),c=this.h.handleExternalCall(a,b,c||null),(c=kh(a,c))&&this.i&&!this.g&&hh(this.b,a,c))}}};
l.Oa=function(a,b){this.i&&!this.g&&hh(this.b,a,this.aa(a,b))};
l.aa=function(a,b){if(null!=b)return{value:b}};
function ih(a,b){b in a.f&&(a.removeEventListener(b,a.f[b]),delete a.f[b])}
l.l=function(){var a=this.b;a.g||ad(a.b,"command",this.na,this);this.b=null;for(var b in this.f)ih(this,b);gh.u.l.call(this)};function lh(a,b){gh.call(this,b);this.h=a;this.start()}
A(lh,gh);lh.prototype.addEventListener=function(a,b){this.h.addEventListener(a,b)};
lh.prototype.removeEventListener=function(a,b){this.h.removeEventListener(a,b)};
...
lh.prototype.aa=function(a,b){switch(a){case "onReady":return;case "onStateChange":return{playerState:b};case "onPlaybackQualityChange":return{playbackQuality:b};case "onPlaybackRateChange":return{playbackRate:b};case "onError":return{errorCode:b}}return lh.u.aa.call(this,a,b)};
lh.prototype.l=function(){lh.u.l.call(this);delete this.h};function mh(a,b,c,d){G.call(this);this.f=b||null;this.o="*";this.h=c||null;this.sessionId=null;this.channel=d||null;this.D=!!a;this.m=x(this.w,this);window.addEventListener("message",this.m)}
n(mh,G);mh.prototype.w=function(a){if(!("*"!=this.h&&a.origin!=this.h||this.f&&a.source!=this.f)&&r(a.data)){try{var b=JSON.parse(a.data)}catch(c){return}if(!(null==b||this.D&&(this.sessionId&&this.sessionId!=b.id||this.channel&&this.channel!=b.channel))&&b)switch(b.event){case "listening":"null"!=a.origin&&(this.h=this.o=a.origin);this.f=a.source;this.sessionId=b.id;this.b&&(this.b(),this.b=null);break;case "command":this.i&&(!this.j||0<=za(this.j,b.func))&&this.i(b.func,b.args,a.origin)}}};
mh.prototype.sendMessage=function(a,b){var c=b||this.f;if(c){this.sessionId&&(a.id=this.sessionId);this.channel&&(a.channel=this.channel);try{var d=xc(a);c.postMessage(d,this.o)}catch(e){Q(e,"WARNING")}}};
mh.prototype.l=function(){window.removeEventListener("message",this.m);G.prototype.l.call(this)};function nh(a,b,c){mh.call(this,a,b,c||P("POST_MESSAGE_ORIGIN",void 0)||window.document.location.protocol+"//"+window.document.location.hostname,"widget");this.j=this.b=this.i=null}
n(nh,mh);function oh(){var a=this.g=new nh(!!P("WIDGET_ID_ENFORCE")),b=x(this.Ia,this);a.i=b;a.j=null;this.g.channel="widget";if(a=P("WIDGET_ID"))this.g.sessionId=a;this.h=[];this.j=!1;this.i={}}
l=oh.prototype;l.Ia=function(a,b,c){"addEventListener"==a&&b?(a=b[0],this.i[a]||"onReady"==a||(this.addEventListener(a,ph(this,a)),this.i[a]=!0)):this.pa(a,b,c)};
l.pa=function(){};
...
l.dispose=function(){this.g=null};function rh(a){oh.call(this);this.b=a;this.f=[];this.addEventListener("onReady",x(this.Ha,this));this.addEventListener("onVideoProgress",x(this.Sa,this));this.addEventListener("onVolumeChange",x(this.Ta,this));this.addEventListener("onApiChange",x(this.Na,this));this.addEventListener("onPlaybackQualityChange",x(this.Pa,this));this.addEventListener("onPlaybackRateChange",x(this.Qa,this));this.addEventListener("onStateChange",x(this.Ra,this))}
A(rh,oh);l=rh.prototype;l.pa=function(a,b,c){if(this.b[a]){b=b||[];if(0<b.length&&bh(a)){var d=b;if(ua(d[0])&&!w(d[0]))d=d[0];else{var e={};switch(a){case "loadVideoById":case "cueVideoById":e=dh.apply(window,d);break;case "loadVideoByUrl":case "cueVideoByUrl":e=ch.apply(window,d);break;case "loadPlaylist":case "cuePlaylist":e=eh.apply(window,d)}d=e}fh(d);b.length=1;b[0]=d}this.b.handleExternalCall(a,b,c);bh(a)&&qh(this,this.ba())}};
...
l.Pa=function(a){qh(this,{playbackQuality:a})};
l.Qa=function(a){qh(this,{playbackRate:a})};
...
l.Ta=function(){qh(this,{muted:this.b.isMuted(),volume:this.b.getVolume()})};
l.Sa=function(a){a={currentTime:a,videoBytesLoaded:this.b.getVideoBytesLoaded(),videoLoadedFraction:this.b.getVideoLoadedFraction(),currentTimeLastUpdated_:z()/1E3,playbackRate:this.b.getPlaybackRate(),mediaReferenceTime:this.b.getMediaReferenceTime()};this.b.getProgressState&&(a.progressState=this.b.getProgressState());qh(this,a)};
l.dispose=function(){rh.u.dispose.call(this);for(var a=0;a<this.f.length;a++){var b=this.f[a];this.b.removeEventListener(b.eventType,b.listener)}this.f=[]};function sh(){G.call(this);this.b=new I;mc(this,y(nc,this.b))}
A(sh,G);sh.prototype.subscribe=function(a,b,c){return this.g?0:this.b.subscribe(a,b,c)};
sh.prototype.H=function(a){return this.g?!1:this.b.H(a)};
sh.prototype.j=function(a,b){this.g||this.b.I.apply(this.b,arguments)};function th(a,b,c){sh.call(this);this.f=a;this.h=b;this.i=c}
A(th,sh);function hh(a,b,c){if(!a.g){var d=a.f;d.g||a.h!=d.b||(a={id:a.i,command:b},c&&(a.data=c),d.b.postMessage(xc(a),d.h))}}
th.prototype.l=function(){this.h=this.f=null;th.u.l.call(this)};function uh(a,b,c){G.call(this);this.b=a;this.h=c;this.i=V(window,"message",x(this.j,this));this.f=new th(this,a,b);mc(this,y(nc,this.f))}
...
uh.prototype.l=function(){gf(this.i);this.b=null;uh.u.l.call(this)};function vh(){var a=wh()?"//googleads.g.doubleclick.net/pagead/id?exp=nomnom":"//googleads.g.doubleclick.net/pagead/id",b=bb(xh);return new H(function(c,d){b.C=function(a){ue(a)?c(a):d(new yh("Request failed, status="+a.status,"net.badstatus",a))};
b.onError=function(a){d(new yh("Unknown request error","net.unknown",a))};
b.K=function(a){d(new yh("Request timed out","net.timeout",a))};
Ce(a,b)})}
...
zh.prototype.then=function(a,b,c){return this.f?this.f.then(a,b,c):1===this.g&&a?(a=a.call(c,this.b),Ec(a)?a:Ah(a)):2===this.g&&b?(a=b.call(c,this.b),Ec(a)?a:Bh(a)):this};
zh.prototype.getValue=function(){return this.b};
Dc(zh);function Bh(a){var b=new zh;a=void 0===a?null:a;b.g=2;b.b=void 0===a?null:a;return b}
function Ah(a){var b=new zh;a=void 0===a?null:a;b.g=1;b.b=void 0===a?null:a;return b}
;function Ch(a){B.call(this,a.message||a.description||a.name);this.isMissing=a instanceof Dh;this.isTimeout=a instanceof yh&&"net.timeout"==a.errorCode;this.isCanceled=a instanceof Sc}
n(Ch,B);Ch.prototype.name="BiscottiError";function Dh(){B.call(this,"Biscotti ID is missing from server")}
n(Dh,B);Dh.prototype.name="BiscottiMissingError";var xh={format:"RAW",method:"GET",timeout:5E3,withCredentials:!0},Eh=null;function Fh(){if("1"===Xa(Nd(),"args","privembed"))return Jc(Error("Biscotti ID is not available in private embed mode"));Eh||(Eh=Rc(vh().then(Gh),function(a){return Hh(2,a)}));
return Eh}
function wh(){var a;(a=!!Xa(window,"settings","experiments","flags","html5_serverside_pagead_id_sets_cookie"))||(a=!!P("EXP_HTML5_SERVERSIDE_PAGEAD_ID_SETS_COOKIE",!1));return a||!!T("html5_serverside_pagead_id_sets_cookie")}
...
function Jh(a,b){U(function(){Rc(vh().then(Gh,function(a){return Hh(b,a)}),pa)},a)}
function Ih(a){t("yt.ads.biscotti.lastId_",a,void 0)}
function Kh(){try{var a=v("yt.ads.biscotti.getId_");return a?a():Fh()}catch(b){return Jc(b)}}
;function Lh(a){B.apply(this,arguments)}
n(Lh,B);Lh.prototype.name="MutsuError";function Mh(){var a=new Lh("ID is missing"),b=new Lh("Timeout"),c=null,d=!1;Jd(function(){c=Hd();d=!0});
if(d)return c?Ah(c):Bh(a);var e=new H(function(b,c){Jd(function(){var d=Hd();d?b(d):c(a)})}),f=od().then(function(){return Jc(b)});
return Pc(Mc([e,f]),function(){return f.cancel()})}
;function Nh(a){if("1"!==Xa(Nd(),"args","privembed")){a&&!v("yt.ads.biscotti.getId_")&&t("yt.ads.biscotti.getId_",Fh,void 0);try{var b=Kh();if(T("enable_mutsu")){v("yt.ads.mutsu.getId_")||t("yt.ads.mutsu.getId_",Mh,void 0);try{var c=v("yt.ads.mutsu.getId_")()}catch(d){c=Jc(d)}}else c=Jc(new Lh("unimplemented"));Nc([b,c]).then(function(a){var b=a[0];a=a[1];if(b.Z||a.Z){b=b.value;a=a.value;var c={};c.dt=Rb;c.flash=yd||"0";a:{try{var d=window.top.location.href}catch(Oa){d=2;break a}d=null!=d?d==window.document.location.href?
...
F.navigator.mimeTypes.length);d.ca_type=xd?"flash":"image";if(T("enable_server_side_search_pyv")||T("enable_server_side_mweb_search_pyv")){k=window;try{var m=k.screenX;var u=k.screenY}catch(Oa){}try{var R=k.outerWidth;var tg=k.outerHeight}catch(Oa){}try{var ug=k.innerWidth;var vg=k.innerHeight}catch(Oa){}m=[k.screenLeft,k.screenTop,m,u,k.screen?k.screen.availWidth:void 0,k.screen?k.screen.availTop:void 0,R,tg,ug,vg];u=window.top;try{var S=(u||window).document,Na="CSS1Compat"==S.compatMode?S.documentElement:
S.body;var Aa=(new Gb(Na.clientWidth,Na.clientHeight)).round()}catch(Oa){Aa=new Gb(-12245933,-12245933)}S={};Na=0;p.SVGElement&&p.document.createElementNS&&(Na|=1);S.bc=Na;S.bih=Aa.height;S.biw=Aa.width;S.brdim=m.join();Aa=(S.vis={visible:1,hidden:2,prerender:3,preview:4,unloaded:5}[Pb.webkitVisibilityState||Pb.mozVisibilityState||Pb.visibilityState||""]||0,S.wgl=!!F.WebGLRenderingContext,S);for(var Ad in Aa)d[Ad]=Aa[Ad]}void 0!==b&&(d.bid=b);void 0!==a&&(d.mutsuid=a);d.bsq=Oh++;Ie("//www.youtube.com/ad_data_204",
{za:!1,A:d})}});
U(Nh,18E5)}catch(d){Q(d)}}}
var Oh=0;var Z=v("ytglobal.prefsUserPrefsPrefs_")||{};t("ytglobal.prefsUserPrefsPrefs_",Z,void 0);function Ph(){this.b=P("ALT_PREF_COOKIE_NAME","PREF");var a;if(a=Xb.get(""+this.b,void 0)){a=decodeURIComponent(a).split("&");for(var b=0;b<a.length;b++){var c=a[b].split("="),d=c[0];(c=c[1])&&(Z[d]=c.toString())}}}
...
qa(Ph);var Th=null,Uh=null,Vh=null,Wh={};function Xh(a){Mf(a.payload_name,a.payload,void 0,void 0)}
function Yh(a){var b=a.id;a=a.ve_type;var c=pf++;a=new nf(void 0,a,c,void 0,void 0);Wh[b]=a;b=wf();c=vf();b&&c&&Pf(b,c,a)}
function Zh(a){var b=a.csn;a=a.root_ve_type;if(b&&a&&(O("client-screen-nonce",b),O("ROOT_VE_TYPE",a),a=vf()))for(var c in Wh){var d=Wh[c];d&&Pf(b,a,d)}}
function $h(a){Wh[a.id]=new nf(a.tracking_params)}
function ai(a){var b=wf();a=Wh[a.id];b&&a&&(T("interaction_click_on_gel_web")?Mf("visualElementGestured",{csn:b,ve:of(a),gestureType:"INTERACTION_LOGGING_GESTURE_TYPE_GENERIC_CLICK"}):Qf({click:{csn:b,visualElement:of(a)}}))}
function bi(a){a=a.ids;var b=wf();if(b)for(var c=0;c<a.length;c++){var d=Wh[a[c]];d&&Mf("visualElementShown",{csn:b,ve:of(d),eventType:1})}}
...
t("writeEmbed",function(){var a=P("PLAYER_CONFIG",void 0);Nh(!0);"gvn"==a.args.ps&&(document.body.style.backgroundColor="transparent");var b=document.referrer,c=P("POST_MESSAGE_ORIGIN");window!=window.top&&b&&b!=document.URL&&(a.args.loaderUrl=b);P("LIGHTWEIGHT_AUTOPLAY")&&(a.args.autoplay="1");a.args.autoplay&&fh(a.args);Th=a=$g(a);a.addEventListener("onScreenChanged",Zh);a.addEventListener("onLogClientVeCreated",Yh);a.addEventListener("onLogServerVeCreated",$h);a.addEventListener("onLogToGel",Xh);
a.addEventListener("onLogVeClicked",ai);a.addEventListener("onLogVesShown",bi);a.addEventListener("onReady",ci);b=P("POST_MESSAGE_ID","player");P("ENABLE_JS_API")?Vh=new rh(a):P("ENABLE_POST_API")&&r(b)&&r(c)&&(Uh=new uh(window.parent,b,c),Vh=new lh(a,Uh.f));P("BG_P")&&(P("BG_I")||P("BG_IU"))&&oe();Ze()},void 0);
t("yt.www.watch.ads.restrictioncookie.spr",function(a){Le(a+"mac_204?action_fcts=1");return!0},void 0);
var di=Od(function(){yg("ol");var a=Ph.getInstance(),b=!!((Sh("f"+(Math.floor(119/31)+1))||0)&67108864),c=1<window.devicePixelRatio;if(document.body&&qc(document.body,"exp-invert-logo"))if(c&&!qc(document.body,"inverted-hdpi")){var d=document.body;d.classList?d.classList.add("inverted-hdpi"):qc(d,"inverted-hdpi")||(d.className+=0<d.className.length?" inverted-hdpi":"inverted-hdpi")}else!c&&qc(document.body,"inverted-hdpi")&&rc();b!=c&&(b="f"+(Math.floor(119/31)+1),d=Sh(b)||0,d=c?d|67108864:d&-67108865,
0==d?delete Z[b]:Z[b]=d.toString(16).toString(),a.save())}),ei=Od(function(){var a=Th;
a&&a.sendAbandonmentPing&&a.sendAbandonmentPing();P("PL_ATT")&&(ne=null);a=0;for(var b=Xe.length;a<b;a++)We(Xe[a]);Xe.length=0;le("//static.doubleclick.net/instream/ad_status.js");Ye=!1;O("DCLKSTAT",0);oc(Vh,Uh);if(a=Th)a.removeEventListener("onScreenChanged",Zh),a.removeEventListener("onLogClientVeCreated",Yh),a.removeEventListener("onLogServerVeCreated",$h),a.removeEventListener("onLogToGel",Xh),a.removeEventListener("onLogVeClicked",ai),a.removeEventListener("onLogVesShown",bi),a.removeEventListener("onReady",
ci),a.destroy();Wh={}});
